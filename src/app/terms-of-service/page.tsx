...
const services = [
  ...
  { name: "Water Supply", description: "Continuous water supply" },
  {
    ...
    description: "Free access to purified drinking water",
  },
  {
  ...
  { name: "Study Tables", description: "Dedicated study area in rooms" },
  {
    ...
    description: "Private bathrooms in select rooms",
  },
  {
    name: "Shared Washrooms",
    description: "Clean, well-maintained shared bathrooms",
  },
  ...
  {
    name: "Food Service (Optional)",
    description: "Breakfast, lunch, and dinner available at INR 3000/month",
  },
];
...
export default async function Services() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-6">
        At AligarhHostel.com, we provide a range of services to ensure a
        comfortable and productive stay for our residents:
      </p>
      ...
      <div className="mt-8 bg-blue-100 border-l-4 border-blue-500 p-4 rounded">
        ...
        <p className="mt-2">
          Security deposit: INR 1000 (refundable if no damage)
        </p>
      </div>

      <p className="mt-6 text-sm text-gray-600">
        Note: Smoking and drinking are strictly prohibited in the hostel
        premises.
      </p>
    </div>
  );
